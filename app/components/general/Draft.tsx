...
const MenuBar: React.FC<{ editor: Editor | null }> = ({ editor }) => {
  ...
  return (
      <div className="button-group">
        <div className="text-size-label">Text Size</div>
        <select className="text-size-select" value={textSize} onChange={changeSize} >
        ...
        onClick={() => editor.chain().focus().toggleItalic().run()} style={{marginRight: '21.38px',cursor: 'pointer',transition: 'color 0.3s',}} className="italic-button">
