...
const LoginClient = () => {
  ...
  const showInput = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    setLoginProcess(1);
  }
  ...
  return (
    <div>
      {process == 0 ? (
        ...
        backgroundColor='#FFFFFF' textColor='#242220'
        borderLine={1} borderColor='#E7E5E4'
        fontSize={19} fontWeight={600} />
            ...
            {loginProcess == 0 ? (
              ...
              <div>
                <div style={{display: "flex",width: "252px", marginBottom: "20px"}}><Input id="email" placeholder="Email" type="email" required value={email} onChange={emailChange} /></div>
                <div style={{display: "flex",width: "252px", marginBottom: "24px"}}><Input id="password" placeholder="Password" type="password" required value={password} onChange={passwordChange} /></div>
                ...
                <div><Button text="Continue" onClick={complete} 
                paddingTop={15} paddingBottom={15} 
                paddingLeft={92} paddingRight={91}
                fontSize={15} /></div>
              </div>)}        
      </div>)
      }
