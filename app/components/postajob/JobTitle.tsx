...
const JobTitle: React.FC<JobTitleProps> = ({ jobTitle, setJobTitle, isFormSubmitted = false }) => {
  ...
  return (
    <div ref={dropdownRef} className={styles.jobTitleContainer}>
